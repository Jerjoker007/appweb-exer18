...
**Titre:** _Travail pratique 01 - Développement d'applications Web_
...
- Malheureusement, `watch` de Vue est _moyennement_ lisible.
...
- Le `body` du modal comporte une faute de _participe passé_:
  - Remplacer « supprimé » par « supprimer ».
- Le **nommage** des classes de _style_ pourrait être plus clair.
...
- Le bouton pourrait simplement **émettre** un événement de _clic_ pour éviter sa dépendance envers la méthode d'exportation.
